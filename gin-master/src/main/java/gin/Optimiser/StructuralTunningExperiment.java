...
import static gin.Optimiser.StructuralTunningExperimentRunner.isPrintSteps;
        ...
        try {
            ...
            if(device.isRunInVivo)
            {
                ...
                if(result.MAE < StructuralTunningExperimentRunner.MAE_CONSTRAINT)
                {
                    ...
                    copyEvaluationValuesFile(PHONE_LOGS_DIRECTORY.concat("\\"+device.currentEvaluationNumber),App_Directory);
