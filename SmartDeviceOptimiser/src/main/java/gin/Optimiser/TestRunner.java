...
public class TestRunner {
    ...
    public TestResult test(Patch patch, int reps) {
        ...
        // Otherwise, compileUsingAndroidSDK tests and return
    ...
    protected boolean compile()  {
        ...
        /*System.out.format("%s, line %d in %s",
                diagnosticListener.getMessage( null ),
                diagnosticListener.getLineNumber(),
                diagnosticListener.getSource().getName() );*/
     ...
     */
    protected TestResult loadClassAndRunTests(int reps) {
        ...
        try {
            ...
            // Hard load SpringTest
            //loadedTestClass = classLoader.loadClass("com.example.mahmoud.modifiedrebound.SpringTest");
